...
from module import Embedding, SA
...
class NaivePCT(nn.Module):
    def __init__(self, d_out):
        ...
        self.linear = nn.Sequential(
            nn.Conv1d(512, d_out, kernel_size=1, bias=False),
...
class Classification(nn.Module):
    def __init__(self, d_in, num_categories=40):
        super().__init__()

        self.linear1 = nn.Linear(d_in, 512, bias=False)
